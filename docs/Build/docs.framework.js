...
var ASM_CONSTS = {
  4857328: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4857389: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4857453: function() {return Module.webglContextAttributes.powerPreference;},  
 4857511: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4857566: function($0) {performance.now = function() { return $0; };},  
 4857614: function($0) {performance.now = function() { return $0; };},  
 4857662: function() {performance.now = Module['emscripten_get_now_backup'];}
};
...
var asmLibraryArg = {
  ...
  "invoke_viiffiiiffii": invoke_viiffiiiffii,
  "invoke_viifi": invoke_viifi,
  "invoke_viifii": invoke_viifii,
  "invoke_viii": invoke_viii,
  "invoke_viiiffiiiffii": invoke_viiiffiiiffii,
...
function invoke_viiiffiiiffii(index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12) {
  var sp = stackSave();
  try {
    dynCall_viiiffiiiffii(index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12);
  } catch(e) {
    stackRestore(sp);
    if (e !== e+0) throw e;
    _setThrew(1, 0);
...
function invoke_viiffiiiffii(index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11) {
  var sp = stackSave();
  try {
